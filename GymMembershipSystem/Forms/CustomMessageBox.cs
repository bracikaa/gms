...
namespace GymMembershipSystem
{
    public class MyLabel : Label
    {
        ...
        public static Label SetOKLabel(string Text = "")
        {
            Label l = new Label();
            l.Text = Text;
            l.Font = new Font("Calibri", 12);
            l.ForeColor = Color.White;
            l.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(38)))), ((int)(((byte)(69)))), ((int)(((byte)(119)))));
            l.AutoSize = true;
            return l;
        }
    }
    public class MyButton : Button
    {
        ...
        public static Button SetOKThemeButton()
        {
            Button b = new Button();
            b.Text = "OK";
            b.Width = 102;
            b.Height = 30;
            b.Font = new Font("Calibri", 12);
            b.ForeColor = System.Drawing.Color.White;
            b.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(38)))), ((int)(((byte)(69)))), ((int)(((byte)(119)))));
    ...
    public class MyImage : PictureBox
    {
        ...
        public static PictureBox SetSuccess()
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string ImagePath = string.Format("{0}Resources\\tick.png", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
            PictureBox i = new PictureBox();
            if (ImagePath != null)
            {
                i.BackgroundImageLayout = ImageLayout.Zoom;
        ...
        public static PictureBox SetFailed()
        {
            string RunningPath = AppDomain.CurrentDomain.BaseDirectory;
            string ImagePath = string.Format("{0}Resources\\error.png", Path.GetFullPath(Path.Combine(RunningPath, @"..\..\")));
            PictureBox i = new PictureBox();
            if (ImagePath != null)
            {
                i.BackgroundImageLayout = ImageLayout.Zoom;
    ...
    public partial class MyMessageBox : Form
    {
        private MyMessageBox()
        {
            ...
            this.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(38)))), ((int)(((byte)(69)))), ((int)(((byte)(119)))));
            ...
            this.MinimumSize = new Size(180, 130);
